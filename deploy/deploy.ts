...
const deployFunction: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  dim('\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
  dim('PoolTogether Badger-WBTC-Vault Yield Source - Deploy Script');
  dim('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n');
  ...
  cyan(`\nDeploying BadgerWBTCVaultYieldSource...`);
  const badgerWbtcVaultYieldSourceResult = await deploy('WBTCVaultYieldSource', {
    from: deployer,
  });
  displayResult('BadgerWBTCVaultYieldSource', badgerWbtcVaultYieldSourceResult);
};
